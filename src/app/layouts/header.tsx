        ...
        <>
            ...
            <div className='z-10 fixed xl:left-22 lg:left-10 bottom-0 side_panels hidden lg:block'>
                <ul className='flex flex-col gap-3 justify-center'>
                    <li>
                        <a className='p-2 inline-block group text-[var(--foreground-muted)] hover:text-[var(--primary-accent)] hover:transform hover:translate-y-[-3px] transition duration-300' href="https://github.com/imvikasdeep" target='_blank' aria-label="GitHub">
                    ...
                    <li>
                        <a className='p-2 inline-block group text-[var(--foreground-muted)] hover:text-[var(--primary-accent)] hover:transform hover:translate-y-[-3px] transition duration-300' href="https://x.com/Im_vikasdeep" target='_blank' aria-label="Twitter">
                            <svg height='20' width='20' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg>
                        </a>
                    </li>
                    <li>
                        <a className='p-2 inline-block group text-[var(--foreground-muted)] hover:text-[var(--primary-accent)] hover:transform hover:translate-y-[-3px] transition duration-300' href="https://www.linkedin.com/in/imvikasdeep/" target='_blank' aria-label="LinkedIn">
                            <svg height='20' width='20' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
                        </a>
                    </li>
                    <li>
                        <a className='p-2 inline-block group text-[var(--foreground-muted)] hover:text-[var(--primary-accent)] hover:transform hover:translate-y-[-3px] transition duration-300' href="https://codepen.io/im_vikasdeep" target='_blank' aria-label="CodePen">
            ...
            <div className='z-10 flex-col fixed xl:right-22 lg:right-10 bottom-0 side_panels hidden lg:flex'>
                <a className='writing-vertical inline-block text-[var(--primary-accent)] hover:translate-y-[-3px] transition duration-300' href="mailto:vikasdeep3098@gmail.com" target='_blank'>vikasdeep3098@gmail.com</a>
            </div>
        </>
    )
}
